...
**Documentation**: https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.0/html-single/install/index
...
**Documentation**: https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.0/html/manage_cluster/importing-a-target-managed-cluster-to-the-hub-cluster
...
**Documentation (Provider Connection)**: https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.0/html/manage_cluster/creating-a-provider-connection

**Documentation (Create Cluster)**: https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.0/html/manage_cluster/creating-a-cluster-with-red-hat-advanced-cluster-management-for-kubernetes
...
**Documentation**: https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.0/html/web_console/web-console#observability-in-the-console
...
**Bonus Task**: Upgrade the major version of a cluster using a [configuration policy.](https://github.com/open-cluster-management/policy-collection/blob/master/community/CM-Configuration-Management/policy-upgrade-openshift-cluster.yaml)

**Documentation**: https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.0/html/manage_cluster/upgrading-your-cluster

**Success Criteria**: From the ACM Console under Automated Infrastructure -> Cluster one can select to upgrade cluster from one minor version to another. During the upgrade process one may see the upgrade cycling from failed/unknown/upgrading as it takes approximately 30-45 minutes depending on size and resources of the cluster. During the upgrade process one can also use the Launch to console action to view the upgrade experience. Cluster is upgraded from one minor to the selected target minor ot (bonus) the cluster’s upgrade channel is updated and a major upgrade is undertaken.
...
**Documentation**: https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.0/html/manage_applications/index

**Sample Application Yaml**: https://github.com/open-cluster-management/deploy/blob/master/demo/app/devapp/devapp.yaml
...
**Documentation**: https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.0/html/manage_applications/managing-applications#placement-rules
...
**Documentation**: https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.0/html/manage_applications/index and https://github.com/open-cluster-management/demo-subscription-gitops.git

**Success Criteria**: The application is successfully deployed to multiple clusters.
...
**Documentation**: Manage Security policies: https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.0/html/security/security#manage-security-policiesPolicy

**Overview**: https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.0/html/security/security#policy-overviewSample

**Policies**: https://github.com/open-cluster-management/policy-collection
...
**Documentation**: https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.0/html/web_console/web-console
